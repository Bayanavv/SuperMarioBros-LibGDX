package com.bayanav.mariobros.actors.weapons;
...
public class Fireball extends RigidBody {
    ...
    public Fireball(PlayScreen playScreen, float x, float y, boolean movingRight) {
        ...
        setRegion((TextureRegion) firing.getKeyFrame(0, true));
    ...
    public void update(float delta) {
        ...
        if (!hit) {
            setRegion((TextureRegion) firing.getKeyFrame(stateTime, true));
