...
import com.bayanav.mariobros.actors.items.Item;
...
public class Mario extends RigidBody {
    ...
    public void update(float delta) {
        ...
        switch (currentState) {
            ...
            case FIREMARIOING:
                setRegion((TextureRegion) fireMarioing.getKeyFrame(stateTime, false));
                ...
                if (isGrownUp) {
                    if (isInvincible) {
                        if (showFiringAnimation) {
                            setRegion((TextureRegion) firingBigInvincible[invincibleFrame].getKeyFrame(stateTime, true));
                        }
                        else {
                            setRegion((TextureRegion) runningBigInvincible[invincibleFrame].getKeyFrame(stateTime, true));
                        }
                    }
                    else if (isFireMario) {
                        if (showFiringAnimation) {
                            setRegion((TextureRegion) firingAnimation.getKeyFrame(stateTime, true));
                        }
                        else {
                            setRegion((TextureRegion) runningFireMario.getKeyFrame(stateTime, true));
                        }
                    }
                    else {
                    ...
                    if (isInvincible) {
                        setRegion((TextureRegion) runningSmallInvincible[invincibleFrame].getKeyFrame(stateTime, true));
                    }
                    else {
            ...
            case BRAKING:
                if (isGrownUp) {
                    if (isInvincible) {
                        if (showFiringAnimation) {
                            setRegion((TextureRegion) firingBigInvincible[invincibleFrame].getKeyFrame(0, true));
                        }
                        else {
                        ...
                        if (showFiringAnimation) {
                            setRegion((TextureRegion) firingAnimation.getKeyFrame(0, true));
                        }
                        else {
            ...
            case CLIMBING:
                if (isGrownUp) {
                    if (isInvincible) {
                        setRegion((TextureRegion) climbingBigInvincible[invincibleFrame].getKeyFrame(stateTime, true));
                    }
                    else {
                        if (isFireMario) {
                            setRegion((TextureRegion) climbingFireMario.getKeyFrame(stateTime, true));
                        } else {
                            setRegion((TextureRegion) climbingBig.getKeyFrame(stateTime, true));
                        }
                    }
                }
                else {
                    if (isInvincible) {
                        setRegion((TextureRegion) climbingSmallInvincible[invincibleFrame].getKeyFrame(stateTime, true));
                    }
                    else {
                        setRegion((TextureRegion) climbingSmall.getKeyFrame(stateTime, true));
                    }
                }
